...
export async function GET(request) {
  ...
  try {
    ...
    const rows = await queryRows(
      `SELECT id, created_at, agent_name, event_type, action, trigger,
              risk_score, severity, status, workflow_name, node_name,
    ...
    console.error("[api/history/audit]", err.message);
