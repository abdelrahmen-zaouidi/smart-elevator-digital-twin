...
| [operations.md](operations.md) | Backup/restore/DR, TimescaleDB hypertable cutover, structured-log correlation, and the Prometheus/Grafana observability profile. |
